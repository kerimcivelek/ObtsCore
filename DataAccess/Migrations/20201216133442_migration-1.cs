    ...
    public partial class migration1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PackDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PackDetails_Packets_PackId",
                        column: x => x.PackId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PeriodKm = table.Column<int>(type: "int", nullable: false),
                    Status = table.Column<bool>(type: "bit", nullable: false),
                    Note = table.Column<string>(type: "ntext", nullable: true),
                    UserId = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OperationDetails_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OperationDetails_OperationTypes_OperationTypeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OperationDetails_CategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OperationDetails_OperationTypeId",
                table: "OperationDetails",
